...
describe VersionsController do
  ...
  let(:valid_attributes) { { "hit_points" => "" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved version as @version" do
        ...
        post :create, {:version => { "hit_points" => "invalid value" }}, valid_session
        assigns(:version).should be_a_new(Version)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested version" do
        ...
        Version.any_instance.should_receive(:update).with({ "hit_points" => "" })
        put :update, {:id => version.to_param, :version => { "hit_points" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the version as @version" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Version.any_instance.stub(:save).and_return(false)
        put :update, {:id => version.to_param, :version => { "hit_points" => "invalid value" }}, valid_session
        assigns(:version).should eq(version)
      end
